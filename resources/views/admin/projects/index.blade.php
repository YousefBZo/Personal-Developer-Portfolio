...
<div x-data="{
    ...
    editData: { id: null, name: '', description: '', link: '' },
    deleteId: null,
    ...
    <div class="flex justify-between items-center mb-6">
        <p class="text-gray-600">Showcase your portfolio projects.</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($projects as $project)
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    @if($project->link)
                        <a href="{{ $project->link }}" target="_blank" class="text-blue-600 text-sm hover:underline mt-2 inline-block">
                            View Project →
                        </a>
                    @endif
                    <div class="flex justify-end space-x-2 mt-4 pt-4 border-t">
                        <button @click="openEditModal({ id: {{ $project->id }}, name: '{{ addslashes($project->name) }}', description: `{{ addslashes($project->description) }}`, link: '{{ addslashes($project->link ?? '') }}' })"
        ...
        @empty
            <div class="col-span-full bg-white rounded-lg shadow p-12 text-center">
                ...
                <p class="mt-2 text-gray-500">No projects found. Add your first project!</p>
            </div>
        @endforelse
    </div>
                ...
                <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="create-link" class="block text-sm font-medium text-gray-700">Project Link</label>
                                <input type="url" name="link" id="create-link"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                       placeholder="https://...">
                            </div>
                            <div>
                                <label for="create-image" class="block text-sm font-medium text-gray-700">Project Image</label>
    ...
    <div x-show="showEditModal"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showEditModal"
                 ...
                 x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                 class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form :action="'{{ url('admin/projects') }}/' + editData.id" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="edit-link" class="block text-sm font-medium text-gray-700">Project Link</label>
                                <input type="url" name="link" id="edit-link"
                                       x-model="editData.link"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                       placeholder="https://...">
                            </div>
                            <div>
                                <label for="edit-image" class="block text-sm font-medium text-gray-700">Project Image</label>
    ...
    <div x-show="showDeleteModal"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showDeleteModal"
                 ...
                 x-transition:leave-end="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"
                 class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <form :action="'{{ url('admin/projects') }}/' + deleteId" method="POST">
                    @csrf
                    @method('DELETE')
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
